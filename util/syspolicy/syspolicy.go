...
func GetPreferenceOptionPolicy(name Key) (PreferenceOptionPolicy, error) {
	opt, err := GetPolicyString(name, "user-decides")
	if err != nil {
...
func GetVisibilityPolicy(name Key) (VisibilityPolicy, error) {
	opt, err := GetPolicyString(name, "show")
	if err != nil {
...
func GetDurationPolicy(name Key, defaultValue time.Duration) (time.Duration, error) {
	opt, err := GetPolicyString(name, "")
	if opt == "" || err != nil {
